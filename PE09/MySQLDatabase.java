  ...
  //getData (PE06)
    ...
    */
    ...
    PreparedStatement prepareStmnt = prepare(query,str);
         // if(values.size() == 2){
//                prepareStmnt.setString(1, values.get(0));
//                prepareStmnt.setString(2, values.get(1));
//             }
//             else if(values.size()==1){
//                prepareStmnt.setInt(1,Integer.parseInt(values.get(0)));
//             }
...
//PE09
           for(int i=0; i < values.size(); i++) {
            if(checkInteger(values.get(i))) {
               ...
               prepareStmnt.setString(i+1, values.get(i));
            }
         }
    //Statement stmnt = conn.createStatement();
 ...
 //Roll Back Transaction PE07
  ...
  //PE09
    /**
     * Method:       checkInteger
     * Description:  this method is used to check if the passed
     *               string is an integer or not.
     *               <BR>
     * @param        ip The String to check
     * @return       The returned value is a boolean indicating
     *               if the string can be converted to int
     */ 
  public boolean checkInteger(String ip) {
     try {
